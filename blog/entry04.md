...
##### 3/14/26
### Context
As we are at a good point to start to brainstorm ideas for our freedom project we have had time to stop tinkering and see what we would like to build and using our learning logs to help guide on what we can use from our tools. I have to this to my advantage and started to list down my project ideas that I had or brainstormed throughout the past months as entering march and getting closer to our *expo* we were encouraged to act fast and prepare for when it's time to build. 
...
I mostly used **creativity** since my teacher **Mr.Mueller** adviced use to *really* start thinking on our project ideas but also continue to learn and tinker even though we will mostly start to plan and build, using **time management** as well to brainstorm ideas with time from the weekends that I had since school and homework took most of my time I had, using this I got to search for past projects that user's have created and what I could do from my past tinker projects that I did from my learning log.
